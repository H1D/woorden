...
// Frequency bands shown in the explainer table.
const BAND_ROWS: { band: string; label: string; zipf: string }[] = [
  { band: "A1", label: "A1", zipf: "Zipf ≥ 5.0" },
  { band: "A2", label: "A2", zipf: "Zipf 4.5 – 5.0" },
  { band: "B1", label: "B1", zipf: "Zipf 4.0 – 4.5" },
  { band: "B2", label: "B2", zipf: "Zipf 3.5 – 4.0" },
  { band: "C", label: "C1/C2 — advanced / rare", zipf: "Zipf < 3.5" },
];
    ...
    >
      <div className="about-inner">
        ...
        <details name="about">
          ...
          <p>
            Each word gets a <b>frequency score</b> (the “Zipf” scale: roughly,
            each point higher means a word is ten times more common). The score
            maps to a level like this:
          </p>
        ...
        <details name="about">
          ...
          <p>
            ...
            drops the highest and lowest outlier source per word so none
            dominates. A word&rsquo;s <b>Zipf score</b> is the base-10 logarithm
            of how often it appears per billion words (see the{" "}
            <a
